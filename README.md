...
***ID-TELOS*** es una plataforma de verificación, cuyo _objetivo final_ es ***cambiar el paradigma de la experiencia de usuario***, al momento de visitar un motel.

***ID-TELOS*** nace debido a la profunda necesidad que tienen nuestros moteles colaboradores, por mejorar la experiencia de usuario que entregan a sus clientes, pero también debido a la necesidad de estos últimos, de encontrar una experiencia de usuario superior, mejorada y renovada. 

No cabe duda que los productos y servicios que ofrecen nuestros moteles asociados, son de primera categoría, pero hacía falta algo, un paso más allá que transformara la experiencia de los usuarios de excelente a _Inolvidable_. 

Con esta premisa se gesta ***ID-TELOS***.

 Somos un garante entre nuestros moteles y sus clientes, sin que estos últimos deban dejar ninguna garantía de dinero, sino a través de la verificación de una tarjeta de crédito válida, la cual debe coincidir con los datos de identidad provistos por el usuario. Gracias a esto, el usuario tiene acceso a 2 servicios exclusivos, que cambiarán por completo su experiencia en un motel y a los que solo puede acceder a través de ***ID-TELOS***. 

 :large_orange_diamond: El usuario hará pago de todos los servicios y productos que contrate y requiera, al final de su estadía, y no al momento de ingresar al hotel ni al momento de requerir algo adicional. 

 :large_orange_diamond: El usuario puede reservar habitaciones en su motel preferido, sin tener que dejar una garantía de dinero. 
...
Luego de una gran lluvia de ideas, e ires y venires, nos dimos cuenta que, podíamos aplicar este mecanismo, al mundo de los moteles; si bien estos son lugares de alojamiento de paso, su objetivo principal es satisfacer y llevar a cabo las fantasías y deseos de sus clientes; Pero, a pesar de ofrecer productos y servicios de primera clase, faltaba un pequeño toque, que no solo apelara a la excelencia, sino lograra hacer sentir a sus usuarios especiales, importantes, consiguiendo transformar el sentimiento de ser simples usuarios de paso de un gran servicio, a ser el eje central de la experiencia. 

Es así como nace ***ID-TELOS***... 
Somos un voto de confianza entre nuestros clientes y sus usuarios... Un garante participativo, que busca satisfacer tanto las necesidades de nuestros clientes, así como las de nuestros usuarios. 
...
nos permitió tener una perspectiva de cuales eran los objetivos a cumplir, versus la cantidad de tiempo que teníamos para ello, pudiendo así dividir este tiempo entre las distintas etapas de la realización. 

En primer lugar llevamos a cabo un desglose de todas las tareas que teníamos cumplir. 
Para esto utilizamos la plataforma Trello, donde fuimos desglosando cada tarea pendiente, cada tarea realizada, las temáticas a investigar y los objetivos por cumplir.
...
Es muy importante llevar a cabo este paso, ya que va a permitir verificar de manera efectiva, si contamos con los recursos suficientes para realizar nuestro proyecto, así como distribuirlos de manera eficiente durante las diferentes etapas involucradas. 

También es fundamental ir diariamente revisando los avances, los pendientes e ir re organizando las tareas en el tiempo, según sea pertinente a las necesidades del desarrollo del proyecto, ya que, todos los procesos creativos y de desarrollo son dinámicos, por ende, estan sujetos a cambios. Es clave lograr identificar cuando debemos comprender estos cambios y adaptar nuestro proceso a ellos. 
...
Todo el proceso de la creación de esta aplicación fue realmente interesante y desafiante. 
Somos un equipo que está comenzando 100% desde cero, y cada paso del proceso fue un reto a nivel investigativo, teórico y de aprendizaje, lo cual hizo que tuvieramos que poner todo nuestro esfuerzo en el. 

Nos dimos cuenta que, a pesar que estuvimos siempre trabajando para sacar adelante el programa, el recurso tiempo se nos hizo corto, ya que no logramos completar el proyecto en su totalidad. Esto nos sirve de experiencia, ya que para una futura instancia, sabemos que tenemos que redoblar el esfuerzo en lo que más nos cuesta, así como comenzar por lo más difícil, porque lo que se nos hace más fácil, va a lograrse de manera mas expedita. 

También es importante destacar que para nosotras el trabajo en equipo fue clave, ya que gracias a esto, pudimos apoyarnos en nuestros conocimientos, e ir trabajando juntas nuestras debilidades, para así ir aprendiendo en conjunto a lo largo del proceso. 

Descubrimos que es muy interesante el proceso de diseño UX, el cuál disfrutamos de gran manera, y llevamos a cabo con mucha pasión. 

En cuanto al proyecto en sí, podemos decir que ***ID-TELOS*** sí cumple con su objetivo final, ya que, los servicios que ofrece, permiten tanto a los moteles entregar una mejor experiencia de usuario para sus clientes, así como los usuarios, pueden acceder a servicios que van a satisfacer su necesidad por encontrar una experiencia de usuario superior. 


Gracias a todas las pruebas de usuarios realizadas, tenemos en consideración algunos puntos que nos pueden servir para mejoras en el futuro, en la próxima versión de ***ID-TELOS***. 
Dentro de las mejoras sugeridas por los usuarios queremos destacar las siguientes:
...
Agradecemos en primer lugar a nuestras familias, quienes fueron un gran apoyo en todo este proceso,acompañándonos en nuestras casas, y siendo comprensivos ante nuestra ausencia y trabajo arduo de estos días. 

También queremos agradecer al equipo de Laboratoria, a nuestro Jedi y a nuestras Coachs y Psicólogas, quienes nos guiaron y alentaron para poder ir avanzando en los desafíos que implicaba la realización de este proyecto, así como fueron un apoyo emocional para albergar todos nuestros procesos y sentimientos a flor de piel. 

Por último, pero no menos importante, queremos agradecer a nuestras compañeras de Squad, quienes siempre estuvieron ahí para darnos una palabra de aliento, un consejo, o simplemente estuvieron presentes con su compañerismo, que fue una dosis vitaminica para todas, en esta grandiosa experiencia. 
